...
As aulas são gratuitas. Certificado não é requisito do roadmap.

## Regra dos exercícios em vídeo

1. Assista somente ao enunciado.
2. Pause e faça uma tentativa executável.
3. Teste pelo menos um caso comum e um caso de borda.
4. Veja a resolução apenas para comparar abordagens.
5. Corrija a própria versão sem copiar o código inteiro.
...
## Complementos ensinados pelo roadmap

O curso cobre `for`; não é necessário procurar outra aula para aprendê-lo. Os complementos abaixo não têm cobertura equivalente nessa seleção e aparecem somente quando passam a ser úteis:
