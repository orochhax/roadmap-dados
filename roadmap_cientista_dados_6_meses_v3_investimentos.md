---
title: Roadmap Intensivo — Cientista de Dados Júnior
aliases:
  - Roadmap Data Science 6 Meses
  - Plano de Estudos Cientista de Dados
start_date: 2026-08-03
end_date: 2027-01-29
duration: 26 semanas
study_days: segunda a sexta
status: planejado
tags:
  - carreira
  - data-science
...
# Roadmap Intensivo — Cientista de Dados Júnior
...
- Aplicar estatística e probabilidade em problemas reais.
- Desenvolver, avaliar e explicar modelos tradicionais de Machine Learning.
- Construir projetos completos, do problema de negócio ao deploy.
- Utilizar Git, GitHub, FastAPI, Docker e uma plataforma de nuvem ou Databricks.
- Desenvolver uma aplicação simples de IA generativa com RAG.
- Possuir currículo, LinkedIn, GitHub e apresentação dos projetos prontos.
- Conseguir explicar decisões técnicas e impacto de negócio em entrevistas.

## Princípios do plano

1. **70% prática e 30% teoria.**
2. Todo assunto deve gerar um notebook, script, consulta SQL, miniaplicação ou documentação.
3. Todo dia deve incluir recuperação ativa: refazer, testar e explicar sem consulta.
4. Não avançar carregando lacunas graves em Python, SQL ou estatística.
5. Todo projeto precisa responder a uma pergunta de negócio, não apenas prever uma variável.
6. Publicar código compreensível: README, organização, instruções de execução e conclusões.
7. Começar candidaturas antes de “se sentir pronto”.
8. Não trocar de curso toda semana. Escolher uma fonte principal e usar outras apenas para dúvidas.
...
- **0:** não executei;
- **1:** executei copiando;
- **2:** executei com muita consulta;
- **3:** executei sozinho em situação conhecida;
...
| Critério | Peso |
|---|---:|
| Funcionamento e correção técnica | 35% |
| Uso consciente dos conceitos da semana | 25% |
| Clareza do código e reprodutibilidade | 20% |
| Explicação e conexão com negócio | 20% |

### Rubrica dos projetos mensais e do TCC

| Critério | Peso |
|---|---:|
| Qualidade técnica e validação | 25% |
| Integração dos conhecimentos acumulados | 20% |
| Utilidade para uma decisão real | 20% |
| Reprodutibilidade, testes e documentação | 15% |
| Comunicação e defesa das decisões | 10% |
...
| Data | Tipo | Entrega principal |
|---|---|---|
| 28/08/2026 | Projeto mensal 1 | Painel Executivo de Operações Telecom |
| 25/09/2026 | Projeto mensal 2 | Experimento de Retenção orientado por SQL e Estatística |
| 30/10/2026 | Projeto mensal 3 | Motor de Decisão de Churn com Machine Learning |
| 27/11/2026 | Projeto mensal 4 | Laboratório de Risco de Crédito e Política de Decisão |
| 25/12/2026 | Projeto mensal 5 | Sistema de ML Reproduzível e Implantável |
| 29/01/2027 | Projeto final | TCC — Portfolio Intelligence Lab |
...
- Jupyter
- Git e GitHub
- PostgreSQL ou DuckDB
- DBeaver ou outro cliente SQL
- pandas, NumPy, Matplotlib, scikit-learn
- FastAPI
- Docker
- Power BI Desktop ou alternativa equivalente
- Databricks Community/Free Edition ou ambiente equivalente
...
├── 06-projeto-churn/
├── 07-forecasting/
├── 08-projeto-risco-credito/
├── 09-data-engineering/
├── 10-mlops-api-docker/
├── 11-genai-rag/
├── 12-portfolio-entrevistas/
├── 13-tcc-final/
└── README.md
```

## Projetos principais do portfólio

1. **Churn em telecom:** prever cancelamento e recomendar ações de retenção.
2. **Risco de crédito/fraude:** modelar risco, escolher limiar e calcular custo dos erros.
3. **Forecasting operacional:** prever demanda, receita ou volume de chamados.
4. **RAG para suporte técnico:** consultar documentos e responder com fontes.
5. **TCC final — Portfolio Intelligence Lab:** plataforma de análise, ranking quantitativo e construção de carteiras com ações, ETFs e FIIs.

---

# Semana 01 — Ambiente, Git e fundamentos de Python

**Objetivo:** Preparar o ambiente e dominar a sintaxe indispensável para começar a resolver problemas sem tutorial.
...
# Semana 02 — Python intermediário e código confiável

**Objetivo:** Escrever programas mais organizados, tratar erros e manipular arquivos reais.
...
# Semana 03 — NumPy, pandas e dados tabulares

**Objetivo:** Manipular dados tabulares com segurança e começar a pensar como analista.
...
# Semana 04 — Visualização e comunicação com dados

**Objetivo:** Transformar análises em mensagens claras para pessoas técnicas e não técnicas.
...
# Semana 05 — SQL básico aplicado

**Objetivo:** Consultar, filtrar e resumir dados em banco relacional.
...
# Semana 06 — SQL intermediário e analítico

**Objetivo:** Utilizar SQL em análises semelhantes às cobradas em processos seletivos.
...
# Semana 07 — Estatística descritiva e probabilidade

**Objetivo:** Compreender e aplicar os fundamentos que sustentam análises e modelos.
...
# Semana 08 — Inferência, testes e experimentação

**Objetivo:** Tomar decisões com incerteza e evitar conclusões estatísticas incorretas.
...
# Semana 09 — Fluxo completo de Machine Learning

**Objetivo:** Aprender o processo correto antes de se aprofundar nos algoritmos.
...
# Semana 10 — Regressão e previsão numérica

**Objetivo:** Modelar variáveis contínuas e interpretar erros.
...
# Semana 11 — Classificação: regressão logística e decisão

**Objetivo:** Dominar o modelo mais importante para risco, churn e fraude.
...
# Semana 12 — Árvores e ensembles

**Objetivo:** Aprender modelos não lineares amplamente usados no mercado.
...
# Semana 13 — Feature engineering, validação e explicabilidade

**Objetivo:** Melhorar modelos sem cair em vazamento, ajuste excessivo ou explicações frágeis.
...
# Semana 14 — Projeto 1 — Churn em telecom: problema e dados

**Objetivo:** Iniciar projeto principal conectando sua experiência profissional à Ciência de Dados.
...
# Semana 15 — Projeto 1 — Modelagem, decisão e comunicação

**Objetivo:** Concluir modelagem, traduzir resultados em ação e produzir material de portfólio.
...
# Semana 16 — Séries temporais e forecasting

**Objetivo:** Construir previsões respeitando ordem temporal e incerteza.
...
# Semana 17 — Projeto 2 — Risco de crédito ou fraude

**Objetivo:** Aplicar estatística e ML em um problema de decisão semelhante às vagas de fintech e bancos.
...
# Semana 18 — Engenharia de dados para cientistas

**Objetivo:** Entender ingestão, transformação e rastreabilidade sem tentar virar engenheiro de dados em uma semana.
...
# Semana 19 — Git, testes e engenharia de software

**Objetivo:** Elevar seus projetos de notebooks exploratórios para código confiável.
...
# Semana 20 — API, Docker e deploy de modelo

**Objetivo:** Transformar um modelo em serviço utilizável.
...
# Semana 21 — Cloud, Databricks e ciclo de vida

**Objetivo:** Conhecer o suficiente para conversar sobre execução em ambientes modernos.
...
# Semana 23 — Projeto 3 — RAG para suporte técnico

**Objetivo:** Construir aplicação alinhada à vaga de IA aplicada e à sua experiência profissional.
...
# Semana 24 — Projeto integrador — Produto de Data Science e IA

**Objetivo:** Integrar análise, modelo, software e IA em um sprint controlado antes do TCC.
...
# Semana 25 — Portfólio, entrevistas e pré-projeto do TCC

**Objetivo:** Preparar candidatura e deixar o projeto final completamente especificado antes da última semana.
...
# Semana 26 — TCC final — Portfolio Intelligence Lab

**Objetivo:** Construir, documentar e defender uma plataforma quantitativa que ranqueia ações, ETFs e FIIs, monta carteiras e avalia resultados com validação temporal, custos e controle de vieses.
...
> [!todo] PUBLICAR NO LINKEDIN — projeto prioritário nº 10
> - [ ] Publique um post principal com problema, arquitetura, ranking, backtest, resultados líquidos, limitações e link do GitHub.
> - [ ] Use imagens do dashboard e uma comparação honesta com os baselines.
...
4. Por que os rankings foram separados por classe?
5. Qual baseline foi mais difícil de superar?
6. O resultado permanece após custos maiores?
7. Em quais períodos a estratégia falhou?
8. Qual fator parece menos estável?
9. Como evitar que o ranking seja interpretado como recomendação?
...
# Rotina paralela durante as 26 semanas

## Inglês técnico

De segunda a sexta:

- [ ] Ler 20–30 minutos de documentação, artigo ou issue em inglês.
- [ ] Registrar de 5 a 10 termos técnicos com uma frase de exemplo.
- [ ] Uma vez por semana, explicar um projeto em inglês por dois minutos.
- [ ] A partir da semana 12, ler descrições de vagas em inglês.

## Liderança e comunicação

Toda semana:

- [ ] Escrever uma decisão técnica e sua justificativa.
- [ ] Fazer ao menos uma apresentação curta.
- [ ] Pedir ou simular feedback sobre uma entrega.
- [ ] Registrar uma situação em que priorizou, negociou ou simplificou o escopo.
- [ ] Traduzir ao menos uma métrica técnica em consequência de negócio.

## Candidaturas

### Semanas 1–12

- Observar vagas e registrar requisitos recorrentes.
- Não gastar mais de 30 minutos por semana alterando o plano por causa de uma vaga isolada.

### Semanas 13–19

- Melhorar LinkedIn e conversar com profissionais da área.
- Participar de comunidades, eventos ou grupos técnicos.
- Começar a comentar projetos e aprendizados com consistência.

### A partir da semana 20

- Enviar candidaturas seletivas para vagas aderentes.
- Registrar cargo, empresa, requisitos, data, retorno e lacunas percebidas.
- Ajustar currículo apenas quando houver diferença material entre os tipos de vaga.

### Após a semana 26

Meta sugerida:

- 10–20 candidaturas qualificadas por semana;
- 2 conversas de networking por semana;
- 3 sessões de SQL/Python por semana;
- 1 melhoria de portfólio por semana;
- 1 entrevista simulada a cada duas semanas.
...
- **3:** resolvo sozinho em caso conhecido;
- **4:** aplico em problema novo e explico;
- **5:** ensino, critico e tomo decisões com segurança.

| Competência | Meta para candidaturas |
|---|---:|
| Python | 3–4 |
| pandas/NumPy | 4 |
| SQL | 4 |
| Estatística aplicada | 3–4 |
| Machine Learning tradicional | 3–4 |
| Comunicação de resultados | 4 |
| Git/GitHub | 3 |
| API/FastAPI | 3 |
| Docker | 2–3 |
| Cloud/Databricks | 2–3 |
| IA generativa/RAG | 2–3 |
| Visão de negócio | 4 |

# Checklist mínimo antes de aplicar

- [ ] Tenho pelo menos três projetos fortes e um quarto projeto complementar.
- [ ] Um projeto está ligado à minha experiência anterior ou a um setor real.
- [ ] Consigo escrever JOINs, CTEs e funções de janela.
- [ ] Consigo limpar uma base desconhecida e justificar decisões.
- [ ] Consigo explicar regressão logística, árvores, overfitting e validação.
- [ ] Sei escolher métricas e limiar conforme o custo do erro.
- [ ] Consigo explicar valor-p, intervalo de confiança e teste A/B.
- [ ] Meus repositórios executam e possuem README.
- [ ] Consigo apresentar cada projeto em dois minutos.
- [ ] Tenho currículo e LinkedIn coerentes com o cargo buscado.
- [ ] Sei dizer honestamente o que ainda não domino.

# Indicadores semanais

Crie uma nota semanal com:
...
- Principal evolução:
- Próxima correção:
- Nota técnica da semana: /10
- Nota de consistência: /10
```

# Regras para não desperdiçar os seis meses

> [!danger] Evite estes erros
>
> - Assistir cursos por meses sem construir projetos.
> - Copiar notebooks e chamar isso de portfólio.
> - Começar por deep learning, agentes ou Kubernetes antes de dominar SQL e estatística.
> - Criar 15 projetos superficiais em vez de 4 projetos fortes.
> - Usar o conjunto de teste repetidamente para escolher o modelo.
> - Apresentar correlação como causa.
> - Colocar no currículo ferramentas que não consegue explicar.
> - Esperar estar 100% pronto para se candidatar.
> - Estudar oito horas com baixa concentração e ignorar sono e revisão.

# Avaliação realista do plano

- **Chance de chegar tecnicamente apto para candidaturas:** 8/10, mantendo consistência e produzindo as entregas.
- **Chance de dominar completamente Ciência de Dados em seis meses:** 2/10. Esse não é o objetivo.
- **Maior risco:** consumir teoria demais e não finalizar projetos.
- **Segundo maior risco:** tentar aprender Data Science, Engenharia de Dados, MLOps, Cloud e IA generativa com a mesma profundidade.
- **Critério correto de sucesso:** estar apto a resolver problemas júnior, apresentar evidências e continuar evoluindo durante as candidaturas.

# Próximo passo após concluir

A direção natural será escolher uma especialização inicial com base nas vagas e no que mais gostou:

1. Ciência de decisão, crédito e risco;
2. Product Analytics e experimentação;
3. Machine Learning aplicado;
4. IA generativa e AI Engineering;
5. Forecasting e otimização.

A liderança deve ser desenvolvida desde o primeiro projeto, mas os cargos de Lead e Manager virão depois de credibilidade técnica, impacto e capacidade comprovada de desenvolver pessoas.
