...
Depois siga o [guia e os enunciados deste bloco](<modulos/01-e121/README.md>). Tente os exercícios antes de procurar uma implementação completa.

### Bloco 2 — Geracao com fontes
...
Depois siga o [guia e os enunciados deste bloco](<modulos/02-e122/README.md>). Tente os exercícios antes de procurar uma implementação completa.
