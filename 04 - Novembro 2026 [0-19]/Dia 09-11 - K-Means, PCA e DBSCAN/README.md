...
Depois siga o [guia e os enunciados deste bloco](<modulos/01-e78/README.md>). Tente os exercícios antes de procurar uma implementação completa.

### Bloco 2 — DBSCAN e avaliacao de clusters
...
Depois siga o [guia e os enunciados deste bloco](<modulos/02-e79/README.md>). Tente os exercícios antes de procurar uma implementação completa.
