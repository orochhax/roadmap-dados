...
### Bloco 1 — PyTorch I: tensores, Dataset, DataLoader, autograd e training loop
...
Depois siga o [guia e os enunciados deste bloco](<modulos/01-n19/README.md>). Tente os exercícios antes de procurar uma implementação completa.
