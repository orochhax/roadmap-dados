...
Depois siga o [guia e os enunciados deste bloco](<modulos/01-e89/README.md>). Tente os exercícios antes de procurar uma implementação completa.

### Bloco 2 — Dados e cohorts
...
Depois siga o [guia e os enunciados deste bloco](<modulos/02-e90/README.md>). Tente os exercícios antes de procurar uma implementação completa.
