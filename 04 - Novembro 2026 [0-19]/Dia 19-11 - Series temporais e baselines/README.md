...
Depois siga o [guia e os enunciados deste bloco](<modulos/01-e84/README.md>). Tente os exercícios antes de procurar uma implementação completa.

### Bloco 2 — Baselines temporais
...
Depois siga o [guia e os enunciados deste bloco](<modulos/02-e85/README.md>). Tente os exercícios antes de procurar uma implementação completa.
