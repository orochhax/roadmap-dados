...
Depois siga o [guia e os enunciados deste bloco](<modulos/01-e91/README.md>). Tente os exercícios antes de procurar uma implementação completa.

### Bloco 2 — Politica e custo
...
Depois siga o [guia e os enunciados deste bloco](<modulos/02-e92/README.md>). Tente os exercícios antes de procurar uma implementação completa.
