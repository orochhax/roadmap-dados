...
### Bloco 1 — PyTorch II: MLP, regularização, desbalanceamento e tracking
...
Depois siga o [guia e os enunciados deste bloco](<modulos/01-n20/README.md>). Tente os exercícios antes de procurar uma implementação completa.
