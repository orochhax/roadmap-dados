# Publicacao do servico

**Data de estudo:** 18/02/2027
**Carga planejada:** 2 a 4 horas

## Atividades do dia

### Atividade 1 — Publicacao do servico

#### O que pesquisar
- `Publicacao do servico Python explicado passo a passo`
- `Publicacao do servico Python exercícios práticos`

**Arquivos da atividade:** [abrir a pasta `01-publicacao-do-servico`](<atividades/01-publicacao-do-servico/>)
...
- **Pasta/arquivo principal:** `atividades/01-publicacao-do-servico/roteiro_atividades.md`.
...
- [ ] Publique localmente via Docker Compose ou em serviço gratuito compatível, quando disponível.
- [ ] Execute teste de ponta a ponta com dados novos.
- [ ] Crie página de documentação para consumidores da API.
- [ ] Faça teste de carga leve e registre limites.

- [ ] Grave uma demonstração de cinco minutos do dado até a resposta, incluindo status e latência de uma entrada nova.
- [ ] **Em `atividades/01-publicacao-do-servico/roteiro_atividades.md`:** interrompa o serviço do modelo ou use caminho inválido e confirme que a documentação permite diagnosticar e recuperar.
