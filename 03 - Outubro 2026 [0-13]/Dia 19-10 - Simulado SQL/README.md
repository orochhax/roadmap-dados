...
- **Contexto:** [quantas questões e qual limite de tempo?]
- **Conteúdos avaliados:** [JOIN, CTE, janela, data, cohort ou outros realmente usados]
- **Resultado:** [quantas respostas passaram e como foram conferidas?]
- **Erro 1:** [lacuna, correção e teste]
- **Erro 2:** [lacuna, correção e teste]
- **Erro 3:** [lacuna, correção e teste]
- **Link:** [consulta, relatório ou repositório conferidos]

### Limitação obrigatória

Explique que um simulado curto mede desempenho naquele conjunto e naquele tempo, não experiência profissional nem domínio de todos os bancos SQL.

### Cuidado contra afirmações falsas

Não publique respostas sem executá-las nem converta o resultado em nível `avançado`. Diferencie consulta educacional de trabalho em banco produtivo. Competências, Destaques e headline obedecem ao marco central e não ao post isolado.

### Checklist de publicação

- [ ] Executei todas as consultas mostradas e revisei respostas incorretas.
- [ ] Registrei tempo, resultado e três lacunas reais.
- [ ] Conferi duplicação, nulos e contagens em pelo menos uma consulta.
- [ ] Preenchi o checklist de publicação já existente no projeto.
- [ ] Testei o link público sem depender de caminho local.
- [ ] **URL publicada:**
- [ ] **Data da publicação:**
