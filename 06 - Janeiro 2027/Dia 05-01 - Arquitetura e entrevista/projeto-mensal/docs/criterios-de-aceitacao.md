# criterios-de-aceitacao.md — Arquitetura e entrevista

> Documento preparado somente com o roteiro do roadmap. Nenhuma entrega foi preenchida.

## Roteiro do projeto

### Passo a passo completo
1. [ ] Desenhe a arquitetura final do sistema de churn/risco com dados, pipeline, modelo, API e monitoramento.
2. [ ] Responda às 15 perguntas completas em `../../01-exercicios/perguntas_entrevista.md`.
...
- [ ] Critérios revisados durante a entrega.
