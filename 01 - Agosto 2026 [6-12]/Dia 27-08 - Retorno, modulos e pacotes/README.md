...
Depois siga o [guia e os enunciados deste bloco](<modulos/01-e07/README.md>). Tente os exercícios antes de procurar uma implementação completa.

### Bloco 2 — Modulos e pacotes
...
Depois siga o [guia e os enunciados deste bloco](<modulos/02-e08/README.md>). Tente os exercícios antes de procurar uma implementação completa.
