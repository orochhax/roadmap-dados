...
Depois siga o [guia e os enunciados deste bloco](<modulos/01-e01/README.md>). Tente os exercícios antes de procurar uma implementação completa.
...
Depois siga o [guia e os enunciados deste bloco](<modulos/02-e02/README.md>). Tente os exercícios antes de procurar uma implementação completa.
