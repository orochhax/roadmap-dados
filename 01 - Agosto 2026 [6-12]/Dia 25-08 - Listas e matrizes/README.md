...
Depois siga o [guia e os enunciados deste bloco](<modulos/01-e03/README.md>). Tente os exercícios antes de procurar uma implementação completa.

### Bloco 2 — Listas compostas e matrizes
...
Depois siga o [guia e os enunciados deste bloco](<modulos/02-e04/README.md>). Tente os exercícios antes de procurar uma implementação completa.
