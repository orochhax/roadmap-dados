...
Depois siga o [guia e os enunciados deste bloco](<modulos/01-e05/README.md>). Tente os exercícios antes de procurar uma implementação completa.

### Bloco 2 — Funcoes com parametros
...
Depois siga o [guia e os enunciados deste bloco](<modulos/02-e06/README.md>). Tente os exercícios antes de procurar uma implementação completa.
