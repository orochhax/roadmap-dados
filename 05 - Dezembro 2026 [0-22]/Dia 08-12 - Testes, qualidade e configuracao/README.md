...
Depois siga o [guia e os enunciados deste bloco](<modulos/01-e101/README.md>). Tente os exercícios antes de procurar uma implementação completa.

### Bloco 2 — Qualidade e configuracao
...
Depois siga o [guia e os enunciados deste bloco](<modulos/02-e102/README.md>). Tente os exercícios antes de procurar uma implementação completa.
