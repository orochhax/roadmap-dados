...
### Bloco 1 — Git profissional basico
...
Depois siga o [guia e os enunciados deste bloco](<modulos/01-e99/README.md>). Tente os exercícios antes de procurar uma implementação completa.

### Bloco 2 — Refatoracao de notebook
...
Depois siga o [guia e os enunciados deste bloco](<modulos/02-e100/README.md>). Tente os exercícios antes de procurar uma implementação completa.
