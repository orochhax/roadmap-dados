...
Use os arquivos válidos do N23 com o schema mínimo:
...
Não copie um script SQL completo. Consulte cada comando, escreva a sua versão no arquivo inicial e remova tabelas de laboratório ao encerrar, se elas não forem necessárias ao N25.
