...
### Bloco 1 — Serializacao e pipeline de inferencia
...
Depois siga o [guia e os enunciados deste bloco](<modulos/01-e105/README.md>). Tente os exercícios antes de procurar uma implementação completa.
...
Depois siga o [guia e os enunciados deste bloco](<modulos/02-e106/README.md>). Tente os exercícios antes de procurar uma implementação completa.
