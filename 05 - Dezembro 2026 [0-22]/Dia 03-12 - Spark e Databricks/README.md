...
### Bloco 1 — Databricks e Spark introdutorio
...
Depois siga o [guia e os enunciados deste bloco](<modulos/01-e97/README.md>). Tente os exercícios antes de procurar uma implementação completa.
