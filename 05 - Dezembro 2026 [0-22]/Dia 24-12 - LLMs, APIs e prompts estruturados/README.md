...
Depois siga o [guia e os enunciados deste bloco](<modulos/01-e114/README.md>). Tente os exercícios antes de procurar uma implementação completa.

### Bloco 2 — APIs e prompts estruturados
...
Depois siga o [guia e os enunciados deste bloco](<modulos/02-e115/README.md>). Tente os exercícios antes de procurar uma implementação completa.
