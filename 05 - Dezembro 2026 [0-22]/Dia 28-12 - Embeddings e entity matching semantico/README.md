...
### Bloco 1 — Embeddings e busca semantica
...
Depois siga o [guia e os enunciados deste bloco](<modulos/01-e116/README.md>). Tente os exercícios antes de procurar uma implementação completa.

### Bloco 2 — Entity matching III: embeddings, hard negatives e multilinguismo
...
Depois siga o [guia e os enunciados deste bloco](<modulos/02-n16/README.md>). Tente os exercícios antes de procurar uma implementação completa.
