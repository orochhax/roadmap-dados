# Arquivos CSV, JSON e caminhos + Excecoes e validacao
...
### Bloco 1 — Arquivos CSV, JSON e caminhos
...
Depois siga o [guia e os enunciados deste bloco](<modulos/01-e13/README.md>). Tente os exercícios antes de procurar uma implementação completa.

### Bloco 2 — Excecoes e validacao
...
Depois siga o [guia e os enunciados deste bloco](<modulos/02-e14/README.md>). Tente os exercícios antes de procurar uma implementação completa.
