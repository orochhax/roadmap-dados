...
Depois siga o [guia e os enunciados deste bloco](<modulos/01-e69/README.md>). Tente os exercícios antes de procurar uma implementação completa.

### Bloco 2 — Explicabilidade
...
Depois siga o [guia e os enunciados deste bloco](<modulos/02-e70/README.md>). Tente os exercícios antes de procurar uma implementação completa.
