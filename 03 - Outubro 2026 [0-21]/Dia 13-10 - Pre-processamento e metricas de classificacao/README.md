...
### Bloco 1 — Pre-processamento com Pipeline
...
Depois siga o [guia e os enunciados deste bloco](<modulos/01-e49/README.md>). Tente os exercícios antes de procurar uma implementação completa.

### Bloco 2 — Metricas de classificacao
...
Depois siga o [guia e os enunciados deste bloco](<modulos/02-e50/README.md>). Tente os exercícios antes de procurar uma implementação completa.
