...
Depois siga o [guia e os enunciados deste bloco](<modulos/01-e47/README.md>). Tente os exercícios antes de procurar uma implementação completa.

### Bloco 2 — Separacao e vazamento
...
Depois siga o [guia e os enunciados deste bloco](<modulos/02-e48/README.md>). Tente os exercícios antes de procurar uma implementação completa.
